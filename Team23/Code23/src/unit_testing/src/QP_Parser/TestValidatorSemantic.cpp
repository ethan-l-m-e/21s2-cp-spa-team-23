...
void setUpAttrToken(QueryToken& queryToken) {
    auto declarationTokens = new std::map<std::string, std::string> ({
                                                                             {"s", "stmt"},
                                                                             {"r", "read"},
                                                                             {"pn", "print"},
...
void setUpPattern(QueryToken& queryToken) {
    auto declarationTokens = new std::map<std::string, std::string>({
                                                                            {"s",   "stmt"},
                                                                            {"r",   "read"},
                                                                            {"pn",  "print"},
...
TEST_CASE ("QP SEMANTIC VALIDATOR: PATTERN CHECK") {
    Validator validator = Validator();
    QueryToken queryToken = QueryToken();
    setUpPattern(queryToken);

    // valid synonym - assign
    PatternToken patternToken = PatternToken();
    std::vector<std::string>* arguments = new std::vector<std::string>({"_", "_"});
    patternToken.synonym = "a";
    patternToken.arguments = arguments;
    std::vector<PatternToken>* patternTokens = new std::vector<PatternToken>({patternToken});
    ...
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    REQUIRE_NOTHROW(validator.checkForSemantics(queryToken));

    // valid synonym - ifs
    arguments = new std::vector<std::string>({"_", "_", "_"});
    ...
    setUpPattern(queryToken);
    arguments = new std::vector<std::string>({"\"x\"", "_"});
    patternToken.synonym = "a";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    ...
    arguments = new std::vector<std::string>({"_", "_\"x\"_"});
    patternToken.synonym = "a";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    ...
    arguments = new std::vector<std::string>({"v", "_", "_"});
    patternToken.synonym = "ifs";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    ...
    arguments = new std::vector<std::string>({"\"x\"", "_", "_"});
    patternToken.synonym = "ifs";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    ...
    setUpPattern(queryToken);
    arguments = new std::vector<std::string>({"_", "\"x\"", "_"});
    patternToken.synonym = "ifs";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    ...
    setUpPattern(queryToken);
    arguments = new std::vector<std::string>({"_", "3", "_"});
    patternToken.synonym = "ifs";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
    ...
    setUpPattern(queryToken);
    arguments = new std::vector<std::string>({"_", "_\"x\"_", "_"});
    patternToken.synonym = "ifs";
    patternToken.arguments = arguments;
    patternTokens = new std::vector<PatternToken>({patternToken});
    queryToken.patternTokens = patternTokens;
...
TEST_CASE ("QP SEMANTIC VALIDATOR: SYNONYM IN ARGUMENT NOT DECLARED") {
    ...
    // variable synonym as second argument
    SuchThatClauseToken suchThatClauseToken = SuchThatClauseToken();
    std::vector<std::string>* arguments = new std::vector<std::string>({"s1", "s"});
    suchThatClauseToken.relRef = "Follows";
    suchThatClauseToken.arguments = arguments;
