...
#ifndef SPA_CLAUSEEVALUATORCOLLECTION_H
#define SPA_CLAUSEEVALUATORCOLLECTION_H

#endif //SPA_CLAUSEEVALUATORCOLLECTION_H
...
#include "QP_Evaluator/ClauseEvaluators/AffectsClauseEvaluator.h"
